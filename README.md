...
**OpenDocTools** is a fully client-side document editor that runs entirely in the browser. Click this link to enter the application: https://magicklibrary.github.io/OpenDocTool/
